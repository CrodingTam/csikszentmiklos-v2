...
import { DialogContent, DialogTitle, SxProps, Theme, Typography } from "@mui/material";
  ...
  return (
    <PopupContext.Provider value={popupValue}>
      ...
      >
        ...
        <Close className="close-icon" onClick={() => setOptions({} as Options)} />
        <DialogContent className="popup-content">{options.content}</DialogContent>
      </StyledWrapper>
